...
export const LOAD_TEMPLATES = 'app/TemplateWizard/LOAD_TEMPLATES';
export const TEMPLATES_LOADED = 'app/TemplateWizard/TEMPLATES_LOADED';
export const SAVE_TEMPLATE = 'app/TemplateWizard/SAVE_TEMPLATE';
